...
__all__ = [ 'BasicBlock', 'IfBlock', 'WhileBlock', 'BlockVisitor', 'PrintBlocks' ]

class Block(object):
    '''
    Base class representing a basic block of instructions.
    '''
    def __init__(self):
...
class PrintBlocks(BlockVisitor):
    '''
    Debugging class for viewing basic block structure
    '''
